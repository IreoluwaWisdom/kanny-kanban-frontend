  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      if (errorMessage.includes('popup') || errorMessage.includes('cancelled')) {
        ...
        setError('Unable to sign in with Google. Please try again or use email and password.');
      }
    } finally {
      setLoading(false);
    }
      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription className="text-center">
            Sign in to your Kanny Kanban account
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="relative flex-1 flex justify-center text-xs uppercase">
